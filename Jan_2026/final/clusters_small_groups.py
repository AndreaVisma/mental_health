...
#######
sex_id = 2
age_group = 'midlife 39-64'
try:
    os.mkdir(outfile + f"{sex_dict[sex_id]}_{age_group}//")
except:
    pass

d = np.load(f"C:\\git-projects\\mental_health\\sequence_analysis\\full_medical_spectrum\\store\\dtw_full_{sex_dict[sex_id]}_{age_group}_norm.npy")
ids = np.load(f"C:\\git-projects\\mental_health\\sequence_analysis\\full_medical_spectrum\\store\\IDS_full_{sex_dict[sex_id]}_{age_group}.npy")
...
# )
#
# d_sub = d[np.ix_(sample_idx, sample_idx)]
#
...
#     )
#
#     labels = kmedoids.fit_predict(d_sub)
#
