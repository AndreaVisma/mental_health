...
output_dir = (
    "C:\\git-projects\\mental_health\\sequence_analysis\\full_medical_spectrum\\store"
)
...
# Save outputs
# -------------------
labels_path = os.path.join(output_dir, f"labels_{n_clusters}_clusters_subsample_{gender}_sample_{sample_size}.npy")
indices_path = os.path.join(output_dir, f"indices_{n_clusters}_subsample_{gender}_sample_{sample_size}.npy")
