...
output_path = f"C:\\git-projects\\mental_health\\sequence_analysis\\full_medical_spectrum\\store\\dtw_distance_matrix_{gender}_sampled_{sample}.dat"
...
np.save(
    f"C:\\git-projects\\mental_health\\sequence_analysis\\full_medical_spectrum\\store\\patient_ids_{gender}_sampled_{sample}.npy",
    ids)
